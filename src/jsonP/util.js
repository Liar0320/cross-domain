//https://github.com/larryosborn/JSONP/blob/master/src/jsonp.coffee
...
JSONP = function(options) {
    ...
    if (params.beforeSend({}, params) !== false) {
        ...
        script.onload = script.onreadystatechange = function() {
            var _ref, _ref1;
            if (done || ((_ref = this.readyState) !== 'loaded' && _ref !== 'complete')) {
                return;
            }
            done = true;
            if (script) {
                script.onload = script.onreadystatechange = null;
                if ((_ref1 = script.parentNode) != null) {
                    _ref1.removeChild(script);
                }
                return script = null;
            }
        };
